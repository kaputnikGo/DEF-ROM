...
E13B : 54         lsrb                ;logic shift right B 
E13C : 89 00      adca #$00           ;A = Carry + A + 00h 
E13E : 54         lsrb                ;logic shift right B 
E13F : 89 00      adca #$00           ;A = Carry + A + 00h 
E141 : 54         lsrb                ;logic shift right B 
E142 : 89 00      adca #$00           ;A = Carry + A + 00h 
E144 : 54         lsrb                ;logic shift right B 
E145 : 89 00      adca #$00           ;A = Carry + A + 00h 
E147 : 54         lsrb                ;logic shift right B 
E148 : 89 00      adca #$00           ;A = Carry + A + 00h 
E14A : 54         lsrb                ;logic shift right B 
E14B : 89 00      adca #$00           ;A = Carry + A + 00h 
E14D : 54         lsrb                ;logic shift right B 
...
E15B : 7E 00 94   jmp L0094           ;jump to timer location 0094 (RDELAY)
;ORGAN2:
...
E161 : 44         lsra                ;logic shift right A
E162 : 98 81      eora $81            ;exclusive OR A with addr 81
E164 : 44         lsra                ;logic shift right A
E165 : 44         lsra                ;logic shift right A
E166 : 76 00 80   ror $0080           ;rotate right in addr 0080 
E169 : 76 00 81   ror $0081           ;rotate right in addr 0081 
...
E1C6 : 7A 20 02   dec $2002           ;decr DAC output SOUND
;SYN134 LE1C9:
...
E1EA : 7A 20 02   dec $2002           ;decr DAC output SOUND
;SYN144 LE1ED:
...
E25C : 44         lsra                ;logic shift right A 
E25D : 44         lsra                ;logic shift right A 
E25E : 44         lsra                ;logic shift right A 
E25F : 98 81      eora $81            ;exclusive OR with addr 81 (LO)
E261 : 44         lsra                ;logic shift right A 
E262 : 76 00 80   ror $0080           ;rotate right in addr 0080  (HI)
E265 : 76 00 81   ror $0081           ;rotate right in addr 0081  (LO)
...
E2AD : 7A 00 90   dec $0090     ;decr addr 0090
...
E2BD : 7A 00 90   dec $0090     ;decr addr 0090
...
E2E4 : 7C 00 87   inc $0087     ;incr addr 0087 (TEMPA)(NEXT PHASE)
...
;SCREM1:
E2ED : 6F 00      clr $00,x     ;clear addr X+00h
E2EF : 08         inx           ;incr X
...
;SCREM4:
E30B : 74 00 87   lsr $0087     ;logic shift right  in addr 0087 (TEMPA)(DECAY AMPLITUDE)
...
E318 : 7C 00 88   inc $0088     ;incr addr 0088 (TEMPB)(ADVANCE TIMER)
...
;SCREM6:
E32D : 6A 00      dec $00,x     ;decr addr X+00h (FREQ)
...
E3B1 : 44         lsra               ;logic shift right A 
E3B2 : 44         lsra               ;logic shift right A 
E3B3 : 44         lsra               ;logic shift right A 
E3B4 : 98 81      eora $81           ;exclusive OR with addr 81 (LO)
E3B6 : 44         lsra               ;logic shift right A 
E3B7 : 76 00 80   ror $0080          ;rotate right in addr 0080  (HI)
E3BA : 76 00 81   ror $0081          ;rotate right in addr 0081  (LO)
...
E3F5 : 54         lsrb                ;logic shift right B 
E3F6 : 54         lsrb                ;logic shift right B 
E3F7 : 54         lsrb                ;logic shift right B 
E3F8 : 54         lsrb                ;logic shift right B 
E3F9 : D7 91      stab $91            ;store B in addr 91
E3FB : A6 01      ldaa $01,x          ;load A with addr X + 01h
E3FD : 16         tab                 ;transfer A to B (A unchanged)
E3FE : 54         lsrb                ;logic shift right B 
E3FF : 54         lsrb                ;logic shift right B 
E400 : 54         lsrb                ;logic shift right B 
E401 : 54         lsrb                ;logic shift right B 
...
;GWLD2:
E40D : 7A 00 87   dec $0087           ;decr addr 0087
...
;
E49D : FF 1F 14 01 01 04 1C           ;
;
E4A4 : 1C 1F 00 FF FF 08 88           ; 
;
E4AB : 3D 5C 01 01 01 02 01           ; 
;
...
;
E4C7 : 3A 1F 11 01 10 04 1C           ; 
;
E4CE : 1F F6 FE FE FE 01 21           ; 
;
E4D5 : FF 15 01 0A 01 03 BC           ; - E59F 2nd part SP2SND
;
E4DC : FF 16 00 00 00 08 88           ; 
;*************************************;
...
;Ed's Sound 13
E57D : 17 18 19 1A 1B 1C              ;
E583 : 00 00 00 00                    ;MATCH THE PROMS
;below from Robotron
E587 : 08 80 10 78 18 70 20 60        ;YUKSND
E58F : 28 58 30 50 40 48 00           ;
;
E596 : 01 08 10 01 08 10 01 08 10     ;SP2SND
E59F : 01 08 10 01 08 10 01 08 10     ;
E5A8 : 00                             ;
;
E5A9 : 10 20 40 10 20 40 10 20 40     ;SSPSND
E5B2 : 10 20 40 10 20 40 10 20 40     ;
E5BB : 10 20 40 10 20 40 00           ;
;
E5C2 : 01 40 02 42 03 43 04 44        ;BWSSND
E5CA : 05 45 06 46 07 47 08 48        ;
E5D2 : 09 49 0A 4A 0B 4B 00           ;
;
...
;CKSUM1 LEF04:
EF04 : E9 00      adcb $00,x    ;B = Carry + B + addr X+00h - ADD IN PROGRAM BYTE
...
;
F022 : 7A 00 81   dec $0081           ;decr addr 0081
F025 : 7A 00 80   dec $0080           ;decr addr 0080
F028 : 7A 00 80   dec $0080           ;decr addr 0080
...
F11C : 54         lsrb                ;logic shift right B 
F11D : 54         lsrb                ;logic shift right B 
F11E : 54         lsrb                ;logic shift right B 
F11F : 54         lsrb                ;logic shift right B 
...
F125 : 54         lsrb                ;logic shift right B 
F126 : 54         lsrb                ;logic shift right B 
F127 : 54         lsrb                ;logic shift right B 
F128 : 54         lsrb                ;logic shift right B 
...
;GWLD2:
F134 : 7A 00 87   dec $0087           ;decr addr 0087 (TEMPA)(WAVE FROM #)
...
;GEND40
F1AE : 7A 00 A0   dec $00A0           ;decr addr 00A0 (GECNT)(ECHO ON?)
...
F1B7 : 7A 00 95   dec $0095           ;decr addr 0095 (GDCNT)(DELTA FREQ OVER?)
...
F1C5 : 7D 00 94   tst $0094           ;test addr 0094 (GDFINC)
...
F222 : 54         lsrb                ;logic shift right B 
F223 : 54         lsrb                ;logic shift right B 
F224 : 54         lsrb                ;logic shift right B 
F225 : 54         lsrb                ;logic shift right B  (CALC 1/16TH)
F226 : 08         inx                 ;incr X
...
F22E : 7A 00 87   dec $0087           ;decr addr 0087 (TEMPA)
...
F240 : DE 8E      ldx $8E             ;load X from addr 8E (XPTR)
F242 : A7 00      staa $00,x          ;store A in addr X+00h
F244 : 08         inx                 ;incr X
F245 : DF 8E      stx $8E             ;store X in addr 8E (XPTR)
F247 : DE 8C      ldx $8C             ;load X from addr 8C (XPLAY)
F249 : 08         inx                 ;incr X
F24A : 5A         decb                ;decr B
...
F58A : 54         lsrb                ;logic shift right B 
F58B : 54         lsrb                ;logic shift right B 
F58C : 54         lsrb                ;logic shift right B 
F58D : D8 81      eorb $81            ;exclusive OR with addr 81 (LO)
F58F : 54         lsrb                ;logic shift right B 
...
F598 : 7D 00 96   tst $0096           ;test addr 0096=00 (N=0(MSB), Z=1) (DSFLG)
...
F5DA : 44         lsra                ;logic shift right A 
F5DB : 56         rorb                ;rotate right B 
F5DC : 44         lsra                ;logic shift right A 
F5DD : 56         rorb                ;rotate right B 
F5DE : 44         lsra                ;logic shift right A 
...
F5E6 : 99 90      adca $90            ;A = A + C + addr 90 (FMAX)
...
F61B : 54         lsrb                ;logic shift right B 
F61C : 54         lsrb                ;logic shift right B 
F61D : 54         lsrb                ;logic shift right B 
F61E : 5C         incb                ;logic shift right B 
;PLAY2
F61F : 5A         decb                ;decr B
F620 : 26 FD      bne LF61F           ;branch Z=0 PLAY2
;PLAY3
F622 : 7A 00 98   dec $0098           ;decr addr 0098
F625 : 27 4C      beq LF673           ;branch Z=1 PLAY7
F627 : 7A 00 99   dec $0099           ;decr addr 0099
F62A : 27 4C      beq LF678           ;branch Z=1 PLAY8
F62C : 7A 00 9A   dec $009A           ;decr addr 009A
F62F : 27 4C      beq LF67D           ;branch Z=1 PLAY9
F631 : 7A 00 9B   dec $009B           ;decr addr 009B
...
;PLAY10 
F680 : 6D 18      tst $18,x           ;test addr X + 18h
...
F75E : 44         lsra                ;logic shift right A 
F75F : 44         lsra                ;logic shift right A 
F760 : 44         lsra                ;logic shift right A 
...
F76C : 7A 00 87   dec $0087           ;decr addr 0087 (TEMPA)
F76F : 26 E2      bne LF753           ;branch Z=0 WHIST1
F771 : 7A 00 9A   dec $009A           ;decr addr 009A (FREQZ)
...
F84B : 44         lsra                ;logic shift right A 
F84C : 44         lsra                ;logic shift right A 
...
F893 : 7A 00 98   dec $0098           ;decr addr 0098 (C$FRQ$)(CHECK CYCLES AT FREQUENCY)
F896 : 27 16      beq LF8AE           ;branch Z=1 SING4(GO CHANGE FREQUENCY)
F898 : 7A 00 97   dec $0097           ;decr addr 0097 (C$AMP$)(CHECK CYCLES AT AMPLITUDE)
...
F8DE : 44         lsra                ;logic shift right A 
F8DF : 44         lsra                ;logic shift right A 
F8E0 : 44         lsra                ;logic shift right A 
F8E1 : 98 81      eora $81            ;exclusive OR with addr 81 (LO)
F8E3 : 44         lsra                ;logic shift right A 
...
F9BC : 7D 00 91   tst $0091           ;test addr 0091 (NAMP)(SEE IF DONE)
F9BF : 27 E4      beq LF9A5           ;branch Z=1 NEND(RTS IF FINISHED)
F9C1 : 7D 00 92   tst $0092           ;test addr 0092 (CYCNT)(SEE IF NEXT FREQ)
F9C4 : 26 E4      bne LF9AA           ;branch Z=0 NO1(IF NOT GO FREQ DELAY LOOP)
F9C6 : 7D 00 95   tst $0095           ;test addr 0095 (NFFLG)(SEE IF SWEEP MODE)
...
;NO3:
F9D2 : 7A 00 AD   dec $00AD           ;decr addr 00AD (NFRQ2)
F9D5 : 7A 00 AC   dec $00AC           ;decr addr 00AC (NFRQ)
...
F9E7 : 44         lsra                ;logic shift right A 
F9E8 : 44         lsra                ;logic shift right A 
F9E9 : 44         lsra                ;logic shift right A 
...
F9F4 : 44         lsra                ;logic shift right A 
F9F5 : 76 00 80   ror $0080           ;rotate right in addr 0080  (HI)
F9F8 : 76 00 81   ror $0081           ;rotate right in addr 0081  (LO)
...
FA13 : 54         lsrb                ;logic shift right B  (HALF AMPLITUDE)
...
FA1A : 91 92      cmpa $92            ;compare A wih addr 92 (CYCNT)
...
FB30 : D9 8C      adcb $8C            ;B = Carry + B + addr 8C
...
FB84 : 44         lsra                ;logic shift right A 
FB85 : 44         lsra                ;logic shift right A 
FB86 : 44         lsra                ;logic shift right A 
...
FFBA : 99 92      adca $92            ;add C+A + addr 92 (SWEEP)
