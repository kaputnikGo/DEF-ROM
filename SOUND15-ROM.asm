...
F81A : 97 05      staa  $05           ;store A addr 05 (HI, start Random Generator)
F81C : 4F         clra                ;clear A
F81D : 97 03      staa  $03           ;store A addr 03 (B2FLG)
F81F : 97 00      staa  $00           ;store A addr 00 (BG1FLG)
F821 : 97 01      staa  $01           ;store A addr 01 (BG2FLG)
F823 : 97 02      staa  $02           ;store A addr 02 (SP1FLG)
F825 : 97 04      staa  $04           ;store A addr 04 (ORGFLG)
...
F82F : CE 00 0F   ldx  #$000F         ;load X with 000Fh (#LOCRAM)
F832 : DF 0B      stx  $0B            ;store X addr 0B (0B:XPTR)(SET XSFER)
F834 : CE FD 60   ldx  #$FD60         ;load X with FD60h (VVECT SAW)
...
;*************************************;
;VARI
F83F : 96 17      ldaa  $17           ;load A with addr 17 (VAMP)
F841 : B7 04 00   staa  $0400         ;store A in DAC output SOUND
;VAR0:
F844 : 96 0F      ldaa  $0F           ;load A with addr 0F (LOPER)
F846 : 97 18      staa  $18           ;store A addr 18 (LOCNT)
F848 : 96 10      ldaa  $10           ;load A with addr 10 (HIPER)
F84A : 97 19      staa  $19           ;store A addr 19 (HICNT)
;V0:
F84C : DE 14      ldx  $14            ;load X with addr 14 (SWPDT)
;V0LP:
F84E : 96 18      ldaa  $18           ;load A with addr 18 (LOCNT) (LO CYCLE)
...
F85C : 96 19      ldaa  $19           ;load A with addr 19 (HICNT) (HI CYCLE)
;V2:
F85E : 09         dex                 ;decr X
...
;VSWEEP:
F866 : B6 04 00   ldaa  $0400         ;load A with addr DAC output SOUND
...
F871 : 96 18      ldaa  $18           ;load A with addr 18 (LOCNT)
F873 : 9B 11      adda  $11           ;add A with addr 11 (LODT)
F875 : 97 18      staa  $18           ;store A addr 18 (LOCNT)
F877 : 96 19      ldaa  $19           ;load A with addr 19 (HICNT)
F879 : 9B 12      adda  $12           ;add A with addr 12 (HIDT)
F87B : 97 19      staa  $19           ;store A addr 19 (HICNT)
F87D : 91 13      cmpa  $13           ;compare A with addr 13 (HIEN)
F87F : 26 CB      bne  LF84C          ;branch Z=0 (V0)
F881 : 96 16      ldaa  $16           ;load A with addr 16 (LOMOD)
F883 : 27 06      beq  LF88B          ;branch Z=1 (VARX)
F885 : 9B 0F      adda  $0F           ;add A with addr 0F (LOPER)
F887 : 97 0F      staa  $0F           ;store A addr 0F (LOPER)
...
F88E : 97 16      staa  $16           ;store A addr 16 (DFREQ)
...
F896 : 97 16      staa  $16           ;store A addr 16 (DFREQ)
...
;*************************************;
;LITEN:
F89E : 97 15      staa  $15           ;store A addr 15 (LFREQ)
F8A0 : 86 FF      ldaa  #$FF          ;load A with FFh (HIGHEST AMP)
F8A2 : B7 04 00   staa  $0400         ;store A in DAC output SOUND
F8A5 : D7 11      stab  $11           ;store B addr 11 (CYCNT)
;LITE0:
F8A7 : D6 11      ldab  $11           ;load B with addr 11 (CYCNT)
;LITE1:
F8A9 : 96 06      ldaa  $06           ;load A with addr 06 (LO) (GET RANDOM)
F8AB : 44         lsra                ;logic shift right A
F8AC : 44         lsra                ;logic shift right A
F8AD : 44         lsra                ;logic shift right A 
F8AE : 98 06      eora  $06           ;exclusive OR with addr 06 (LO)
F8B0 : 44         lsra                ;logic shift right A 
F8B1 : 76 00 05   ror  $0005          ;rotate right addr 0005 (HI)
F8B4 : 76 00 06   ror  $0006          ;rotate right addr 0006  (LO)
F8B7 : 24 03      bcc  LF8BC          ;branch C=0 (LITE2)
F8B9 : 73 04 00   com  $0400          ;complement 1s in DAC output SOUND
;LITE2:
F8BC : 96 15      ldaa  $15           ;load A addr 15 (LFREQ)(COUNT FREQ)
;LITE3:
F8BE : 4A         deca                ;decr A
F8BF : 26 FD      bne  LF8BE          ;branch Z=0 (LITE3)
F8C1 : 5A         decb                ;decr B (COUNT CYCLES)
F8C2 : 26 E5      bne  LF8A9          ;branch Z=0 (LITE1)
F8C4 : 96 15      ldaa  $15           ;load A with addr 15 (LFREQ)
F8C6 : 9B 16      adda  $16           ;add A with addr 16 (DFREQ)
F8C8 : 97 15      staa  $15           ;store A addr 15 (LFREQ)
...
F8CF : 97 11      staa  $11           ;store A addr 11 (CYCNT)
F8D1 : 97 14      staa  $14           ;store A addr 14 (NFFLG)
...
;NOISE:
F8DC : 97 0F      staa  $0F           ;store A addr 0F (DECAY)
;NOISE0:
F8DE : DF 12      stx  $12            ;store X addr 12 (NFRQ1)
;NOIS00: 
F8E0 : D7 10      stab  $10           ;store B addr 10 (NAMP)
F8E2 : D6 11      ldab  $11           ;load B with addr 11 (CYCNT)
;NOISE1:
F8E4 : 96 06      ldaa  $06           ;load A with addr 06 (LO)(GET RANDOM BIT)
F8E6 : 44         lsra                ;logic shift right A 
F8E7 : 44         lsra                ;logic shift right A
F8E8 : 44         lsra                ;logic shift right A
F8E9 : 98 06      eora  $06           ;exclusive OR with addr 06 (LO)
F8EB : 44         lsra                ;logic shift right A  
F8EC : 76 00 05   ror  $0005          ;rotate right addr 0005 (HI)
F8EF : 76 00 06   ror  $0006          ;rotate right addr 0006 (LO)
F8F2 : 86 00      ldaa  #$00          ;load A with 00h
F8F4 : 24 02      bcc  LF8F8          ;branch C=0 (NOISE2)
F8F6 : 96 10      ldaa  $10           ;load A with addr 10 (NAMP)
;NOISE2:
F8F8 : B7 04 00   staa  $0400         ;store A in DAC output SOUND
F8FB : DE 12      ldx  $12            ;load X with addr 12 (NFRQ1)(INCREASING DELAY)
;NOISE3:
F8FD : 09         dex                 ;decr X
F8FE : 26 FD      bne  LF8FD          ;branch Z=0 (NOISE3)
F900 : 5A         decb                ;decr B (FIN CYCLE COUNT?)
F901 : 26 E1      bne  LF8E4          ;branch Z=0 (NOISE1)(NO)
F903 : D6 10      ldab  $10           ;load B with addr 10 (NAMP)(DECAY AMP)
F905 : D0 0F      subb  $0F           ;sub B with addr 0F (DECAY) 
F907 : 27 09      beq  LF912          ;branch Z=1 (NSEND)
F909 : DE 12      ldx  $12            ;load X with addr 12 (NFRQ1)(INC FREQ)
F90B : 08         inx                 ;incr X 
F90C : 96 14      ldaa  $14           ;load A with addr 14 (NFFLG)(DECAY FREQ?)
...
F915 : D7 00      stab  $00           ;store B addr 00 (BG1FLG)
F917 : 4F         clra                ;clear A
F918 : 97 15      staa  $15           ;store A addr 15 (DSFLG)
...
F91D : 97 15      staa  $15           ;store A with addr 15 (DSFLG)
...
;*************************************;
;CANNON
F923 : 86 01      ldaa  #$01          ;load A with 01h
F925 : 97 15      staa  $15           ;store A addr 15 (DSFLG)
...
;FNOISE
F930 : 97 14      staa  $14           ;store A addr 14 (FDFLG)
F932 : D7 0F      stab  $0F           ;store B addr 0F (FMAX)
F934 : DF 12      stx  $12            ;store X addr 12 (SAMPC)
F936 : 7F 00 11   clr  $0011          ;clear addr 0011 (FLO)
;FNOIS0:
F939 : DE 12      ldx  $12            ;load X with addr 12 (SAMPC)
...
F942 : D8 06      eorb  $06           ;exclusive OR with addr 06 (LO)
F944 : 54         lsrb                ;logic shift right B 
F945 : 76 00 05   ror  $0005          ;rotate right addr 0005 (HI)
F948 : 76 00 06   ror  $0006          ;rotate right addr 0006 (LO)
F94B : D6 0F      ldab  $0F           ;load B with addr 0F (FMAX)(SET FREQ)
F94D : 7D 00 15   tst  $0015          ;test value addr 0015 (DSFLG)
F950 : 27 02      beq  LF954          ;branch Z=1 (FNOIS2)
F952 : D4 05      andb  $05           ;and B with addr 05 (HI)(DISTORT FREQ)
;FNOIS2:
F954 : D7 10      stab  $10           ;store B addr 10 (FHI)
F956 : D6 11      ldab  $11           ;load B with addr 11 (FLO)
F958 : 91 06      cmpa  $06           ;compare A with addr 06 (LO)
...
F962 : DB 11      addb  $11           ;add B with addr 11 (FLO)
F964 : 99 10      adca  $10           ;add C+A + addr 10 (FHI)
F966 : 25 16      bcs  LF97E          ;branch C=1 (FNOIS5)
F968 : 91 06      cmpa  $06           ;compare A with addr 06 (LO)
...
F974 : D0 11      subb  $11           ;sub B with addr 11 (FLO)
F976 : 92 10      sbca  $10           ;sub C+A + addr 10 (FHI)
F978 : 25 04      bcs  LF97E          ;branch C=1 (FNOIS5)
F97A : 91 06      cmpa  $06           ;compare A with addr 06 (LO)
F97C : 22 F0      bhi  LF96E          ;branch C+Z=0 (FNOIS4)
;FNOIS5:
F97E : 96 06      ldaa  $06           ;load A with addr 06 (LO)
F980 : B7 04 00   staa  $0400         ;store A in DAC output SOUND
F983 : 20 B9      bra  LF93E          ;branch always (FNOIS1)
;FNOIS6:
F985 : D6 14      ldab  $14           ;load B with addr 14 (FDFLG)
F987 : 27 B5      beq  LF93E          ;branch Z=1 (FNOIS1)
F989 : 96 0F      ldaa  $0F           ;load A with addr 0F (FMAX)(DECAY MAX FREQ)
F98B : D6 11      ldab  $11           ;load B with addr 11 (FLO)
...
F997 : DB 11      addb  $11           ;add B with addr 11 (FLO)
F999 : 99 0F      adca  $0F           ;add C+A + addr 0F (FMAX)
F99B : D7 11      stab  $11           ;store B addr 11 (FLO)
F99D : 97 0F      staa  $0F           ;store A addr 0F (FMAX)
...
F9A8 : 97 0B      staa  $0B           ;store B addr 0B (XPTR)
F9AA : CE 00 64   ldx  #$0064         ;load X with 0064h (#100)(STARTING FREQ)
F9AD : DF 07      stx  $07            ;store X addr 07 (TEMPX)
;RADIO1:
F9AF : DB 08      addb  $08           ;add B with addr 08 (TEMPX+1)(ADD FREQ TO TIMER)
F9B1 : 96 0D      ldaa  $0D           ;load A with addr 0D (TEMPA)
F9B3 : 99 07      adca  $07           ;add C+A + addr 07 (TEMPX)
F9B5 : 97 0D      staa  $0D           ;store A addr 0D (TEMPA)
F9B7 : DE 07      ldx  $07            ;load X with addr 07 (TEMPX)
...
;RADIO3:
F9C2 : DF 07      stx  $07            ;store X addr 07 (TEMPX)
F9C4 : 84 0F      anda  #$0F          ;and A with 0Fh (SET POINTER)
F9C6 : 8B 84      adda  #$84          ;add A with 84h (RADSND!.$FF)(2nd byte of addr:84)
F9C8 : 97 0C      staa  $0C           ;store A addr 0C (XPTR+1)
F9CA : DE 0B      ldx  $0B            ;load X with addr 0B (XPTR)
...
F9D8 : 97 0D      staa  $0D           ;store A addr 0D (TEMPA)(ZERO PHASE)
;HYPER1:
F9DA : 4F         clra                ;clear A (ZERO TIME COUNTER)
;HYPER2:
F9DB : 91 0D      cmpa  $0D           ;compare A with addr 0D (TEMPA)
...
F9ED : 7C 00 0D   inc  $000D          ;incr value addr 000D (TEMPA)(NEXT PHASE)
...
;*************************************;
;SCREAM
F9F3 : CE 00 0F   ldx  #$000F         ;load X with 000Fh (#STABLE ZERO FREQS AND TIMES)
;SCREM1:
F9F6 : 6F 00      clr  $00,x          ;clear addr X+00h
F9F8 : 08         inx                 ;incr X
F9F9 : 8C 00 17   cpx  #$0017         ;compare X with 0017h (#SRMEND)
F9FC : 26 F8      bne  LF9F6          ;branch Z=0 (SCREM1)
F9FE : 86 40      ldaa  #$40          ;load A with 40h (START FIRST ECHO)
FA00 : 97 0F      staa  $0F           ;store A addr 0F (STABLE+FREQ)
;SCREM2:
FA02 : CE 00 0F   ldx  #$000F         ;load X with 000Fh (#STABLE INITIALIZE COUNTER)
FA05 : 86 80      ldaa  #$80          ;load A with 80h (INITIALIZE AMPLITUDE)
FA07 : 97 0D      staa  $0D           ;store A addr 0D (TEMPA)
...
FA12 : DB 0D      addb  $0D           ;add B with addr 0D (TEMPA)
;SCREM4:
FA14 : 74 00 0D   lsr  $000D          ;logic shift right addr 000D (TEMPA)(DECAY AMPLITUDE)
FA17 : 08         inx                 ;incr X (NEXT ECHO)
FA18 : 08         inx                 ;incr X
FA19 : 8C 00 17   cpx  #$0017         ;compare X with 0017h (#SRMEND LAST ECHO?)
FA1C : 26 EC      bne  LFA0A          ;branch Z=0 (SCREM3)
FA1E : F7 04 00   stab  $0400         ;store B in DAC output SOUND
FA21 : 7C 00 0E   inc  $000E          ;incr value addr 000E (TEMPB)(ADVANCE TIMER)
FA24 : 26 DC      bne  LFA02          ;branch Z=0 (SCREM2)
FA26 : CE 00 0F   ldx  #$000F         ;load X with 000Fh (#STABLE LOWER NON-ZERO FREQS)
...
FA39 : 08         inx                 ;incr X
FA3A : 08         inx                 ;incr X
FA3B : 8C 00 17   cpx  #$0017         ;compare X with 0017h (#SRMEND)
...
;*************************************;
;ORGANT
FA44 : 7A 00 04   dec  $0004          ;decr addr 0004 (ORGFLG)(MINUS ORGAN FLAG)
...
FA50 : 97 0D      staa  $0D           ;store A addr 0D (TEMPA) (TUNE NUMBER)
...
;ORGNT3:
FA64 : 08         inx                 ;incr X
FA65 : DF 0B      stx  $0B            ;store X addr 0B (XPTR)(NOTE POINTER)
FA67 : BD FC F0   jsr  LFCF0          ;jump sub ADDX
FA6A : DF 09      stx  $09            ;store X addr 09 (XPLAY)(TUNE END)
FA6C : DE 0B      ldx  $0B            ;load X addr 0B (XPTR)
;ORGNT4:
FA6E : A6 00      ldaa  $00,x         ;load A with addr X+00h (TUNE LOOP)
FA70 : 97 11      staa  $11           ;store A addr 11 (OSCIL)
FA72 : A6 01      ldaa  $01,x         ;load A with addr X+01h
FA74 : EE 02      ldx  $02,x          ;load X with addr X+02h
FA76 : DF 0F      stx  $0F            ;store X addr 0F (DUR)
...
FA7E : 08         inx                 ;incr X
FA7F : 08         inx                 ;incr X
FA80 : DF 0B      stx  $0B            ;store X addr 0B (XPTR)
...
;TRANS1:
FAE1 : A6 00      ldaa  $00,x         ;load A addr X+00h
FAE3 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
FAE5 : DE 0B      ldx  $0B            ;load X from value addr 0B (XPTR)
FAE7 : A7 00      staa  $00,x         ;store A addr X+00h
FAE9 : 08         inx                 ;incr X
FAEA : DF 0B      stx  $0B            ;store X addr 0B (XPTR)
FAEC : DE 09      ldx  $09            ;load X from value addr 09 (XPLAY)
FAEE : 08         inx                 ;incr X
FAEF : 5A         decb                ;decr B
FAF0 : 26 EF      bne  LFAE1          ;branch Z=0 (TRANS1)
...
FAF5 : 97 00      staa  $00           ;store A addr 00 (BG1FLG)
FAF7 : 97 01      staa  $01           ;store A addr 01 (BG2FLG)
...
FAFD : 96 01      ldaa  $01           ;load A with addr 01(BG2FLG)(ACTIVATE BG2)
FAFF : 84 7F      anda  #$7F          ;and A with 7Fh (REMOVE OVERRIDE)
FB01 : 81 1D      cmpa  #$1D          ;compare A with 1Dh (#BG2MAX)
FB03 : 26 01      bne  LFB06          ;branch Z=0 (BG2IO)
FB05 : 4F         clra                ;clear A
;BG2IO:
FB06 : 4C         inca                ;incr A
FB07 : 97 01      staa  $01           ;store A addr 01 (BG2FLG)
FB09 : 39         rts                 ;return subroutine
;*************************************;
;Background 2 Routine 
;*************************************;
;BG2
FB0A : 86 0E      ldaa  #$0E          ;load A with 0Eh (#(TRBV-SVTAB)/7) (GET SOUND)
FB0C : BD FB 57   jsr  LFB57          ;jump sub (GWLD)
FB0F : 96 01      ldaa  $01           ;load A with addr 01 (BG2FLG)
...
;BG2LP:
FB17 : 7C 00 13   inc  $0013          ;incr value addr 0013 (GDCNT)
...
;*************************************;
;SP1
FB1F : 86 03      ldaa  #$03          ;load A with 03h (#(CABSHK-VVECT)/9)
FB21 : BD F8 2A   jsr  LF82A          ;jump sub (VARILD)
FB24 : D6 02      ldab  $02           ;load B with addr 02 (SP1FLG)
FB26 : C1 1F      cmpb  #$1F          ;compare B with 1Fh (#SP1MAX-1)
FB28 : 26 01      bne  LFB2B          ;branch Z=0 (SP1A)
FB2A : 5F         clrb                ;clear B
;SP1A:
FB2B : 5C         incb                ;incr B
FB2C : D7 02      stab  $02           ;store B addr 02 (SP1FLG)
FB2E : 86 20      ldaa  #$20          ;load A with 20h (#SP1MAX)
FB30 : 10         sba                 ;sub B from A
FB31 : 5F         clrb                ;clear B
;SP11:
FB32 : 81 14      cmpa  #$14          ;compare A with 14h
FB34 : 23 05      bls  LFB3B          ;branch C+Z=1 (SP12)
...
FB3D : 4A         deca                ;decr A
FB3E : 26 FB      bne  LFB3B          ;branch Z=0 (SP12)
FB40 : D7 0F      stab  $0F           ;store B addr 0F (LOPER)
;SP1LP:
...
;*************************************;
;BON2
FB47 : 96 03      ldaa  $03           ;load A with addr 03 (B2FLG)
FB49 : 26 09      bne  LFB54          ;branch Z=0 (BON21)
FB4B : 7C 00 03   inc  $0003          ;incr value at addr 0003 (B2FLG)
FB4E : 86 0D      ldaa  #$0D          ;load A with 0Dh (#(BONV-SVTAB)/7)
...
FB59 : 1B         aba                 ;add B to A
FB5A : 1B         aba                 ;add B to A
FB5B : 1B         aba                 ;add B to A
FB5C : CE FE D6   ldx  #$FED6         ;load X with FED6h (SVTAB)(SOUND VECTOR TABLE)
FB5F : BD FC F0   jsr  LFCF0          ;jump sub ADDX
FB62 : A6 00      ldaa  $00,x         ;load A with addr X+00h
FB64 : 16         tab                 ;transfer A to B
FB65 : 84 0F      anda  #$0F          ;and A with 0Fh
FB67 : 97 10      staa  $10           ;store A addr 10 (GCCNT)(GET CYCLE COUNT)
...
FB6D : D7 0F      stab $0F            ;store B addr 0F (GECHO)(GET #ECHOS)
FB6F : A6 01      ldaa  $01,x         ;load A with addr X+01h
...
FB76 : D7 11      stab  $11           ;store B addr 11 (GECDEC)
FB78 : 84 0F      anda  #$0F          ;and A with 0Fh (WAVE #)
FB7A : 97 0D      staa  $0D           ;store A addr 0D (TEMPA)(SAVE)
FB7C : DF 07      stx  $07            ;store X addr 07 (TEMPX)(SAVE INDEX)
FB7E : CE FE 37   ldx  #$FE37         ;load X with FE37h (GWVTAB)(CALC WAVEFORM ADDR)
;GWLD2:
FB81 : 7A 00 0D   dec  $000D          ;decr addr 000D (TEMPA)(WAVE FROM #)
FB84 : 2B 08      bmi  LFB8E          ;branch N=1 (GWLD3)(FINIS)
FB86 : A6 00      ldaa  $00,x         ;load A with addr X+00h
FB88 : 4C         inca                ;incr A
FB89 : BD FC F0   jsr  LFCF0          ;jump sub ADDX
FB8C : 20 F3      bra  LFB81          ;branch always (GWLD2)
;GWLD3:
FB8E : DF 14      stx  $14            ;store X addr 14 (GWFRM)
FB90 : BD FC 4B   jsr  LFC4B          ;jump sub (WVTRAN)(XSFER WAVE TO RAM)
FB93 : DE 07      ldx  $07            ;load X with addr 07 (TEMPX)(RESTORE INDEX)
FB95 : A6 02      ldaa  $02,x         ;load A with addr X+02h (GET PREDECAY)
FB97 : 97 16      staa  $16           ;store A addr 16 (PRDECA)
FB99 : BD FC 5D   jsr  LFC5D          ;jump sub (WVDECA) (DECAY IT)
FB9C : DE 07      ldx  $07            ;load X with addr 07 (TEMPX)
FB9E : A6 03      ldaa  $03,x         ;load A with addr X+03h (GET FREQ INC)
FBA0 : 97 12      staa  $12           ;store A addr 12 (GDFINC)
FBA2 : A6 04      ldaa  $04,x         ;load A with addr X+04h (GET DELTA FREQ COUNT)
FBA4 : 97 13      staa  $13           ;store A addr 13 (GDCNT)
FBA6 : A6 05      ldaa  $05,x         ;load A with addr X+05h (GET PATTERN COUNT)
FBA8 : 16         tab                 ;transfer A to B (SAVE)
FBA9 : A6 06      ldaa  $06,x         ;load A with addr X+06h (PATTERN OFFSET)
FBAB : CE FF 3F   ldx  #$FF3F         ;load X with FF3Fh (#GFRTAB)
FBAE : BD FC F0   jsr  LFCF0          ;jump sub ADDX
FBB1 : 17         tba                 ;transfer B to A (GET PATTERN LENGTH)
FBB2 : DF 17      stx  $17            ;store X addr 17 (GWFRQ)(FREQ TABLE ADDR)
FBB4 : 7F 00 1F   clr  $001F          ;clear addr 001F (FOFSET)
FBB7 : BD FC F0   jsr  LFCF0          ;jump sub ADDX
FBBA : DF 19      stx  $19            ;store X addr 19 (FRQEND)
...
;GWAVE
FBBD : 96 0F      ldaa  $0F           ;load A addr 0F (GECHO)
FBBF : 97 1E      staa  $1E           ;store A addr 1E (GECNT)
;GWT4:
FBC1 : DE 17      ldx  $17            ;load X with addr 17 (GWFRQ)
FBC3 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
;GPLAY:
FBC5 : DE 09      ldx  $09            ;load X with addr 09 (XPLAY)(GET NEW PERIOD)
FBC7 : A6 00      ldaa  $00,x         ;load A with addr X+00h
FBC9 : 9B 1F      adda  $1F           ;add A with addr 1F (FOFSET)
FBCB : 97 1D      staa  $1D           ;store A addr 1D (GPER)
FBCD : 9C 19      cpx  $19            ;compare X with addr 19 (FRQEND)
FBCF : 27 26      beq  LFBF7          ;branch Z=1 (GEND)(FINISH ON ZERO)
FBD1 : D6 10      ldab  $10           ;load B with addr 10 (GCCNT)(CYCLE COUNT)
FBD3 : 08         inx                 ;incr X
FBD4 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
;GOUT:
FBD6 : CE 00 20   ldx  #$0020         ;load X with 0020h (#GWTAB)(SETUP WAVEFORM POINTER)
;GOUTLP:
FBD9 : 96 1D      ldaa  $1D           ;load A with addr 1D (GPER)
;GPRLP:
FBDB : 4A         deca                ;decr A (WAIT FOR PERIOD)
FBDC : 26 FD      bne  LFBDB          ;branch Z=0 (GPRLP)
FBDE : A6 00      ldaa  $00,x         ;load A with addr X+00h (OUTPUT SOUND)
FBE0 : B7 04 00   staa  $0400         ;store A in DAC output SOUND
;GPR1
FBE3 : 08         inx                 ;incr X
FBE4 : 9C 1B      cpx  X1B            ;compare X with addr 1B (WVEND)(END OF WAVE?)
FBE6 : 26 F1      bne  LFBD9          ;branch Z=0 (GOUTLP)
FBE8 : 5A         decb                ;decr B
FBE9 : 27 DA      beq  LFBC5          ;branch Z=1 (GPLAY)
...
;GEND
FBF7 : 96 11      ldaa  $11           ;load A with addr 11 (GECDEC)
FBF9 : 8D 62      bsr  LFC5D          ;branch sub (WVDECA)
;GEND40
FBFB : 7A 00 1E   dec  $001E          ;decr value at addr 001E (GECNT)(ECHO ON?)
FBFE : 26 C1      bne  LFBC1          ;branch Z=0 (GWT4)(YES)
FC00 : 96 03      ldaa  $03           ;load A with addr 03 (B2FLG)(STOP BONUS)
FC02 : 26 46      bne  LFC4A          ;branch Z=0 (GEND1)
;GEND50:
FC04 : 96 12      ldaa  $12           ;load A with addr 12 (GDFINC)(CONTINUE FOR FREQ MOD SOUNDS)
FC06 : 27 42      beq  LFC4A          ;branch Z=1 (GEND1)(NO)
FC08 : 7A 00 13   dec  $0013          ;decr value at addr 0013 (GDCNT)(DELTA FREQ OVER?)
FC0B : 27 3D      beq  LFC4A          ;branch Z=1 (GEND1)(YES...)
FC0D : 9B 1F      adda  $1F           ;add A with addr 1F (FOFSET)(UPDATE FREQ OFFSET)
;GEND60:
FC0F : 97 1F      staa  $1F           ;store A addr 1F (FOFSET)
;GEND61:
FC11 : DE 17      ldx  $17            ;load X with addr 17 (GWFRQ)(GET INDEX)
FC13 : 5F         clrb                ;clear B (START FOUND FLAG INIT CLEAR)
;GW0:
FC14 : 96 1F      ldaa  $1F           ;load A with addr 1F (FOFSET)(INC OR DEC?)
FC16 : 7D 00 12   tst  $0012          ;test addr 0012 (GDFINC)
FC19 : 2B 06      bmi  LFC21          ;branch N=1 (GW1)(DEC)
FC1B : AB 00      adda  $00,x         ;add A with addr X+00h (INC)
FC1D : 25 08      bcs  LFC27          ;branch C=1 (GW2)(CARRY=OVERFLOW)
FC1F : 20 0B      bra  LFC2C          ;branch always (GW2A)
;GW1
FC21 : AB 00      adda  $00,x         ;add A with addr X+00h (DEC)
FC23 : 27 02      beq  LFC27          ;branch Z=1 (GW2)(OVERFLOW ON EQ)
FC25 : 25 05      bcs  LFC2C          ;branch C=1 (GW2A)(OVERFLOW IF CARRY CLEAR)
;GW2:
FC27 : 5D         tstb                ;test B (FOUND START YET?)
FC28 : 27 08      beq  LFC32          ;branch Z=1 (GW2B)(NO)
FC2A : 20 0F      bra  LFC3B          ;branch always (GW3)(YES, THIS IS THE END)
;GW2A
FC2C : 5D         tstb                ;test B 
FC2D : 26 03      bne  LFC32          ;branch Z=0 (GW2B)(ALREADY FOUND START)
FC2F : DF 17      stx  $17            ;store X addr 17 (GWFRQ)(FOUND START)
FC31 : 5C         incb                ;incr B
;GW2B:
FC32 : 08         inx                 ;incr X
FC33 : 9C 19      cpx  $19            ;compare X with addr 19 (FRQEND)
FC35 : 26 DD      bne  LFC14          ;branch Z=0 (GW0)(NOT OVER YET)
FC37 : 5D         tstb                ;test B (FOUND START?)
FC38 : 26 01      bne  LFC3B          ;branch Z=0 (GW3)(YES)
FC3A : 39         rts                 ;return subroutine (ALL OVER)
;GW3
FC3B : DF 19      stx  $19            ;store X addr 19 (FRQEND)
FC3D : 96 11      ldaa  $11           ;load A with addr 11 (GECDEC)(RE:XSFER WAVE?)
FC3F : 27 06      beq  LFC47          ;branch Z=1 (GEND0)(NO)
FC41 : 8D 08      bsr  LFC4B          ;branch sub (WVTRAN)(XSFER WAVE)
FC43 : 96 16      ldaa  $16           ;load A with addr 16 (PRDECA)
...
;*************************************;
;WVTRAN
FC4B : CE 00 20   ldx  #$0020         ;load X with 0020h (#GWTAB)
FC4E : DF 0B      stx  $0B            ;store X addr 0B (XPTR)
FC50 : DE 14      ldx  $14            ;load X with addr 14 (GWFRM)
FC52 : E6 00      ldab  $00,x         ;load B with addr X+00h (GET WAVE LENGTH)
FC54 : 08         inx                 ;incr X
FC55 : BD FA E0   jsr  LFAE0          ;jump sub (TRANS)
FC58 : DE 0B      ldx  $0B            ;load X with addr 0B (XPTR)
FC5A : DF 1B      stx  $1B            ;store X addr 1B (WVEND)(GET END ADDR)
...
;WVDECA
FC5D : 4D         tsta                ;test A 
FC5E : 27 2B      beq  LFC8B          ;branch Z=1 (WVDCX)(NODECAY)
FC60 : DE 14      ldx  $14            ;load X with addr 14 (GWFRM)(ROM WAVE INDEX)
FC62 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
FC64 : CE 00 20   ldx  #$0020         ;load X with 0020h (#GWTAB)
FC67 : 97 0E      staa  $0E           ;store A addr 0E (TEMPB)(DECAY FACTOR)
;WVDLP:
FC69 : DF 0B      stx  $0B            ;store X addr 0B (XPTR)
FC6B : DE 09      ldx  $09            ;load X with addr 09 (XPLAY)
FC6D : D6 0E      ldab  $0E           ;load B with value addr 0E (TEMPB)
FC6F : D7 0D      stab  $0D           ;store B addr 0D (TEMPA)(DECAY FACTOR TEMP)
FC71 : E6 01      ldab  $01,x         ;load B with addr X+01h (OFFSET FOR WAVE LENGTH)
...
FC77 : 08         inx                 ;incr X
FC78 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
FC7A : DE 0B      ldx  $0B            ;load X with addr 0B (XPTR)
FC7C : A6 00      ldaa  $00,x         ;load A with addr X+00h
;WVDLP1:
FC7E : 10         sba                 ;sub B from A(DECAY)
FC7F : 7A 00 0D   dec  $000D          ;decr addr 000D (TEMPA)
FC82 : 26 FA      bne  LFC7E          ;branch Z=0 (WVDLP1)
FC84 : A7 00      staa  $00,x         ;store A addr X+00h
FC86 : 08         inx                 ;incr X
FC87 : 9C 1B      cpx  $1B            ;compare X with addr 1B (WVEND)(END OF WAVE?)
FC89 : 26 DE      bne  LFC69          ;branch Z=0 (WVDLP)(NO)
;WVDCX:
...
;*************************************;
;IRQ
FC8C : 8E 00 7F   lds  #$007F         ;load SP with 007Fh (#ENDRAM)
...
FC94 : 84 1F      anda  #$1F          ;and A with 1F (MASK GARB)
FC96 : D6 04      ldab  $04           ;load B with addr 04 (ORGFLG)
FC98 : 27 03      beq  LFC9D          ;branch Z=1 (IRQ00)
FC9A : BD FA 48   jsr  LFA48          ;jump sub (ORGNT1)(ORGAN TUNE)
;IRQ00:
FC9D : 5F         clrb                ;clear B 
FC9E : 81 0E      cmpa  #$0E          ;compare A with 0Eh (#SP1SND)
FCA0 : 27 02      beq  LFCA4          ;branch Z=1 (IRQ00A)
FCA2 : D7 02      stab  $02           ;store B addr 02 (SP1FLG)
;IRQ00A:
FCA4 : 81 12      cmpa  #$12          ;compare A with 12h (#B2SND)
FCA6 : 27 02      beq  LFCAA          ;branch Z=1 (IRQ000)
FCA8 : D7 03      stab  $03           ;store B addr 03 (B2FLG)
;IRQ1:
FCAA : 4D         tsta                ;test A 
FCAB : 27 30      beq  LFCDD          ;branch Z=1 (IRQ3)(INVALID INPUT)
FCAD : 4A         deca                ;decr A (REMOVE OFFSET)
FCAE : 81 0C      cmpa  #$0C          ;compare A with 0Ch
FCB0 : 22 11      bhi  LFCC3          ;branch C and Z=0 (IRQ10)
FCB2 : 81 03      cmpa  #$03          ;compare A with 03h
FCB4 : 26 05      bne  LFCBB          ;branch Z=0 (LFCBB)
...
;IRQ10:
FCC3 : 81 1B      cmpa  #$1B          ;compare A with 1Bh (SPECIAL SOUND?)
FCC5 : 22 0E      bhi  LFCD5          ;branch C and Z=0 (IRQ20)(VARI SOIUND)
FCC7 : 80 0D      suba  #$0D          ;A = A - 0Dh (SUB OFFSET)
FCC9 : 48         asla                ;arith shift left A   (DOUBLE FOR ADDRESSING)
FCCA : CE FD 42   ldx  #$FD42         ;load X with FD42h (#JMPTBL)(INDEX TO JUMP TABLE)(VWTAB)
FCCD : 8D 21      bsr  LFCF0          ;branch sub ADDX (GET CORRECT INDEX)
FCCF : EE 00      ldx  $00,x          ;load X with addr X+00h (GET ADDRESS TO INDEX)
...
;IRQ3:
FCDD : 96 00      ldaa  $00           ;load A with addr 00 (BG1FLG)(BGROUND ACTIVE)
FCDF : 9A 01      oraa  $01           ;OR A with addr 01 (B2FLG)
FCE1 : 27 FE      beq  LFCE1          ;branch Z=1 here (NOPE)
FCE3 : 4F         clra                ;clear A 
FCE4 : 97 03      staa  $03           ;store A addr 03 (B2FLG)(KILL BONUSES)
FCE6 : 96 00      ldaa  $00           ;load A with addr 00 (BG1FLG)
FCE8 : 27 03      beq  LFCED          ;branch Z=1 (IRQXX)
...
;*************************************;
;ADDX
FCF0 : DF 09      stx  $09            ;store X addr 09 (XPLAY)
FCF2 : 9B 0A      adda  $0A           ;add A with addr 0A (XPLAY+1)
FCF4 : 97 0A      staa  $0A           ;store A addr 0A (XPLAY+1)
FCF6 : 24 03      bcc  LFCFB          ;branch C=0 (ADDX1)
FCF8 : 7C 00 09   inc  X0009          ;incr value addr 0009 (XPLAY)
;ADDX1:
FCFB : DE 09      ldx  $09            ;load X with addr 09 (XPLAY)
...
;TILT1
FD01 : 86 20      ldaa  #$20          ;load A with 20h
...
FD11 : DE 09      ldx  $09            ;load X with addr 09
FD13 : 8C 10 00   cpx  #$1000         ;compare X with 1000h
