...
;SUWAIT:
F82C : 20 FE      bra  LF82C          ;branch always SUWAIT
;*************************************;
;Vari Loader
;*************************************;
;VARILD
...
FA9A : 54         lsrb                ;logic shift right B (bit7=0)
FA9B : 54         lsrb                ;logic shift right B (bit7=0)
FA9C : 54         lsrb                ;logic shift right B (bit7=0)
FA9D : 54         lsrb                ;logic shift right B (bit7=0)
