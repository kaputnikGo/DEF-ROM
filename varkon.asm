...
F8F3 : CE 00 14    ldx  #$0014        ;load X with 0014h(#LOCRAM)
...
;*************************************;
;GWPRE
F9B9 : CE FD D4   ldx  #$FDD4         ;load X with FDD4h (GWPTAB)
...
FA6E : 7E F9 9D   jmp  LF99D          ;jump GWVALT
;GEND50
...
;GWCL4X
FC08 : BD F9 B9   jsr  LF9B9          ;jump sub GWVALT
...
FC10 : BD F9 B9   jsr  LF9B9          ;jump sub GWVALT
